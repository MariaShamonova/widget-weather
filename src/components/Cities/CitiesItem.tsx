...
const CitiesItem: FunctionComponent<AppProps> = ({
	data
}) => {
    ...
    let temp = ''
    const description = data.weather.map(el=> (
        temp.concat(capitalFirstSymbol(el.description) + '. ')
    ))
		...
		<div className="cities-item">
            ...
            <div className="cities-item__elem cities-item__speed-wind">
                <div className="speed-wind__item">
                    ...
                    <div className="text">{data.wind.speed.toLocaleString('ru', { minimumFractionDigits: 1 })} m/s</div>
                </div>
                <div className="speed-wind__item">
                    <div className="icon">
            ...
            <div className="cities-item__elem cities-item__humidity">
                Humidity: {data.main.humidity}%
            </div>
            <div className="cities-item__elem cities-item__visibility">
